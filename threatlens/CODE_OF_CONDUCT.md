...
* Malicious use of this security tool
* Encouraging or facilitating unauthorized access to systems
* Other conduct which could reasonably be considered inappropriate

## Security Tool Responsibility

As this is a security testing tool, contributors and users must:

* Only use the tool on systems they have explicit authorization to test
* Follow responsible disclosure practices
* Comply with all applicable laws and regulations
* Not use the tool for malicious purposes
* Not share credentials, API keys, or sensitive data from actual assessments
